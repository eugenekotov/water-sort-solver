...
export class MovingController {
    ...
    moveUpCancel(container: GameContainer, count: number) {
        const movingItems = this.getMovingItems(0, count);
        this.push(container, this.movingItems[0].color!, count);
    ...
    moveToCancel(containerFrom: GameContainer, containerTo: GameContainer, count: number) {
        const color = this.pop(containerTo, count);
        this.push(containerFrom, color, count);
    }
    ...
    private pop(container: GameContainer, count: number): Color {
